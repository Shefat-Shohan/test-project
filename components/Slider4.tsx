...
export default function Slider4() {
  return (
    <div className="h-screen p-4 md:p-16 bg-slideImage4 bg-cover flex flex-col justify-between relative">
      {/* Overlay */}
      ...
      <div className="z-20 flex flex-col items-end">
        <div className="w-full md:max-w-3xl">
          <h2 className="font-tiltWarpFont text-[26px] leading-[30px] md:text-[45px] md:leading-[60px] lg:text-[64px] lg:leading-[81px] text-white text-right lg:text-right">
            Wij bieden een <br className="md:block" /> duurzame en passende
